...
```
`<link href="https://hr365docs.github.io/HR365_Product/css/style.min.css" rel="stylesheet" media="screen" />`{=html}
...
```
```{=html}
<header class="banner overlay bg-cover" data-background="https://hr365docs.github.io/HR365_Product/images/banner.jpg">
```
```{=html}
<nav class="navbar navbar-expand-md navbar-dark">
```
::: {.container .px-2 .px-md-0}
